...
class UnivRankingRepositoryTest {
    ...
    void getUnivRanking() {
        // when
        List<UnivRankingResponse> univRanking = univRankingRepository.getUnivRanking();
    ...
    void getUnivStudentRanking() {
        // when
        List<UnivStudentRankingResponse> snutUnivStudentRanking = univRankingRepository.getUnivStudentRanking("서울과학기술대학교");
        ...
        List<UnivStudentRankingResponse> koreaUnivStudentRanking = univRankingRepository.getUnivStudentRanking("고려대학교");
